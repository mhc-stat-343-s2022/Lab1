...
#### 9.  Based on your histogram from part 7 and your result from part 8, summarize the similarities and differences between a t distribution and a Normal(0, 1) distribution in a sentence or two.



#### 10. (If time, or for extra practice later) Create a density histograms of the 1000 sample values for the variables you created in Steps 2 and 5, along with plots of the pdfs for those random variables.
